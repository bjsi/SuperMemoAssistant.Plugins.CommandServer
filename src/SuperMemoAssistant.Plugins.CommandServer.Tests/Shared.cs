...
namespace SuperMemoAssistant.Plugins.CommandServer.Tests
{
  ...
  public static class Shared
  {
    ...
    public static ISuperMemoRegistry SuperMemoRegistry { get; } = Substitute.For<ISuperMemoRegistry>();
    public static ISuperMemoUI SuperMemoUI { get; } = Substitute.For<ISuperMemoUI>();
